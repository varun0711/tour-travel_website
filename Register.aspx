<%@ page title="" language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Register, App_Web_uqgisbye" %>
 ...
 <form id="RegisterUserForm" action="" method="post">
 	<fieldset>
         <p>
            ...
            <asp:textbox id="name" name="name" type="text" class="text" value="" runat="server"></asp:textbox>
         </p>
        
         <p>
            <label for="tel">Phone Number</label>
            <asp:textbox id="tel" name="tel" type="tel" class="text" value="" runat="server"></asp:textbox>
         </p>
        
         <p>
            <label for="email">Email</label>
            <asp:textbox id="email" name="email" type="email" class="text" value="" runat="server"></asp:textbox>
         </p>
        
         <p>
            <label for="password">Password</label>
            <asp:textbox id="password" name="password" class="text" type="password" runat="server"></asp:textbox>
         </p>
         ...
         <p>
            <asp:Button id="registerNew" type="submit" runat="server"></asp:Button>
         </p>
 	</fieldset>
